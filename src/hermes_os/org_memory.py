...
class OrgMemory:
    ...
    def __init__(self) -> None:
        ...
        self._task_successes: dict[
            str, tuple[str, bool]
        ] = {}  # task_desc_hash -> (description, success)
    ...
    def get_effective_skills(
        self, min_effectiveness: float = 0.3, limit: int = 10
    ...
    def record_task_result(
        self, task_description: str, success: bool, error: str | None = None
    ) -> None:
    ...
    def search_relevant_memory(self, query: str) -> str:
        ...
        if effective_skills:
            skill_lines = [
                f"- **{name}** (effectiveness: {score:.2f})" for name, score in effective_skills
            ]
            parts.append("## Effective Skills\n" + "\n".join(skill_lines))
